...
export default function Conteudo() {
    ...
    return (
        <section className="secaoConteudo">
            ...
            <div className="boxconteudo">
                <h2>{t("Valores")}</h2>
                <p>{t("Nossa empresa se compromete com integridade, confiança, disponibilidade e inovação centrada no cliente para garantir paz e tranquilidade através da segurança de dados.")}<br /><br />

                {t("Paz e Tranquilidade: Na nossa empresa, o valor da paz e tranquilidade é mais do que uma promessa - é um compromisso inabalável com a serenidade e o bem-estar dos nossos clientes. Estamos dedicados a proporcionar uma experiência tranquila e sem preocupações, onde os nossos clientes possam confiar plenamente em nós para resolver quaisquer problemas de forma rápida e eficiente. Nosso objetivo é criar um ambiente onde a paz de espírito seja garantida, onde cada   interação com a nossa empresa inspire confiança e segurança.")}<br /><br />

                {t("Integridade: Na nossa empresa, a integridade é o alicerce sobre o qual construímos cada relacionamento. Assim como trabalhamos incansavelmente para garantir a integridade dos dados dos nossos clientes, também nos dedicamos a cultivar relacionamentos baseados na transparência, honestidade e respeito mútuo.")} <br /><br />

                {t("Disponibilidade: Em nossa empresa, a disponibilidade não é apenas um valor, é uma filosofia que permeia todas as nossas ações. Estamos comprometidos em estar sempre ao alcance de nossos clientes, prontos para oferecer o melhor serviço possível, independentemente do momento ou da situação.")} <br /><br />

                {t("Inovação: Na nossa empresa, a busca constante pela excelência é impulsionada pela inovação. Estamos firmemente comprometidos em não apenas atender, mas também superar as expectativasdos nossos clientes, e acreditamos que a inovação é o caminho para alcançar esse objetivo.")}</p>
